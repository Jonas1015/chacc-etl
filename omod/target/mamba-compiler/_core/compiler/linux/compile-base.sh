...
function readCoreMakeFile() {
  ...
  # Search for the file in all subdirectories in the path: /home/bamboo-agent/bamboo-agent/xml-data/build-dir/METL-METL-JOB1/api/target/mamba-etl/_core/database/$db_engine
...
function readAllMakeFiles() {
  ...
  # Search for all files with the specified filename (sp_makefile) in the path: /home/bamboo-agent/bamboo-agent/xml-data/build-dir/METL-METL-JOB1/api/target/mamba-etl/_etl
...
function consolidateSPsCallerFile() {
  ...
  # Search for core's p_data_processing.sql file in all subdirectories in the path: /home/bamboo-agent/bamboo-agent/xml-data/build-dir/METL-METL-JOB1/api/target/mamba-etl/_core/database/$db_engine
  ...
  # Search for all files with the specified filename in the path: /home/bamboo-agent/bamboo-agent/xml-data/build-dir/METL-METL-JOB1/api/target/mamba-etl/_etl
