...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initialize file table pagination and search if on editor pages
...
function initializeFileTable() {
    // Get all file table instances (for both JSON and SQL editors)
    ...
    fileTables.forEach(table => {
        ...
        if (expandBtn) {
            expandBtn.addEventListener('click', function() {
                ...
                if (isEditorExpanded) {
                    // Expand: Hide file list and make editor full width
